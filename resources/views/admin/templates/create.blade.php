                    ...
                    <div class="col-md-6">
                        <div class="panel panel-card margin-b-30">
                            ...
                            <div class="panel-body">
                                ...
                                <form action="{{route('templates.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group"><label class="col-lg-2 control-label">اسم النموذج</label>

                                        <div class="col-lg-10">
                                            <input type="text" name="name_template"  class="form-control">
                                        </div>
                                    </div>
