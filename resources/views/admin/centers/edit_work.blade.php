                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title">
                            <h1>اضافة اعمال تطوعية <small></small></h1>
                            <ol class="breadcrumb">
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-card margin-b-30">
                            ...
                            <div class="panel-body">
                                ...
                                {!! Form::model($work,['method' => 'POST' , 'action' => ['CenterController@update_works',$work->id] , 'class' => 'form-horizontal']) !!}
                                @csrf
                                @method('PUT')


                                <div class="form-group"><label class="col-lg-2 control-label">العمل التطوعي</label>

                                    <div class="col-lg-10">
                                            <textarea name="projects" id="" cols="30" rows="10" class="form-control">
                                                {{$work->projects}}
                                            </textarea>
                                    </div>
                                </div>
