                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title">
                            <h1>تحديث المعلومات الخاصة باهداف الجمعية<small></small></h1>
                            <ol class="breadcrumb">
                                <li><a href="#"><i class="fa fa-home"></i></a></li>
                                <li class="active">اهداف الجمعية</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- end .page title-->
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-card margin-b-30">
                            ...
                            <div class="panel-body">
                                ...
                                <form action="{{route('target.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
