                    ...
                    <div class="col-md-6">
                        <div class="panel panel-card margin-b-30">
                            ...
                            <div class="panel-body">
                                ...
                                <form action="{{route('career.update',$career->id)}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    ...
                                    <div class="form-group"><label class="col-lg-2 control-label">المسمي الوظيفي</label>
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" value="{{$career->career_name}}" name="career_name" class="form-control">
                                        </div>
                                    </div>
